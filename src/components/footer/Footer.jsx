    ...
    <footer className="border-t bg-surface">
      <div className="mx-auto max-w-7xl px-5 py-12 lg:px-8 lg:py-16">
          ...
          <div className="max-w-xs">
            ...
            <div className="mt-5 flex gap-3">
              <a
                href="#"
                aria-label="Twitter"
                className="grid size-9 place-items-center rounded-xl border border-border bg-card text-muted-foreground transition-colors hover:border-primary/30 hover:text-primary"
              >
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-xs text-muted-foreground sm:flex-row">
          <p>© {new Date().getFullYear()} TaskMint. All rights reserved.</p>
